...
# load image
file_name = os.path.abspath('photos/smile_child.JPG')
try:
...
my_dict = {"labels": [], "logos": [], "text": [], "landmark": [], "sentiment": [], "current_image_metadata":[]}
...
for face in face_response.face_annotations:
    ...
    if likelihood2.name == "LIKELY":
        ...
        my_dict["sentiment"].append("Face does not has joy")
        count_for_neutral += 1
    else:
        continue
...
exifdata = Image.open(file_name).getexif()
another_dict = {}
